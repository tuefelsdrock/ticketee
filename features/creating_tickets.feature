...
# this fails with        bad URI(absolute but no path): javascript: (URI::InvalidURIError)
# but when manually walking through this is works.
# this appears to be a deficiency in using webrunner to automate this test.
